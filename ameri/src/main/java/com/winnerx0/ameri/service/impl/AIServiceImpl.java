...
public class AIServiceImpl implements AIService {
    ...
    public AIServiceImpl(RestTemplate restTemplate, CloudinaryConfig cloudinaryConfig) {
        this.restTemplate = restTemplate;
        this.cloudinaryConfig = cloudinaryConfig;
    }

    @Override
    public NutritionResponse getMealMetadata(AIRequest request) {
//
...
//        }
        ...
        try {
            ...
            return objectMapper.readValue(response.get("candidates").get(0).get("content").get("parts").get(0).get("text").asText().replaceAll("```json", "").replaceAll("```", ""), NutritionResponse.class);
        } catch (IOException e) {
